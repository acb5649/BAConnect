...
<html lang="EN" dir="ltr" xmlns="http://www.w3.org/1999/xhtml">
	...
	<body onload="addField();">
      ...
      Middle Name: <input type = "text" maxlength = "50" value = "" name = "middleName" id = "middleName" /> <br />
      ...
      Username: <input type = "text" maxlength ="50" value = "" name = "username" id = "username" /> <br />
